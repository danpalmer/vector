...
* [**Sinks**][docs.sinks] - [aws_cloudwatch_logs][docs.sinks.aws_cloudwatch_logs], [aws_s3][docs.sinks.aws_s3], [clickhouse][docs.sinks.clickhouse], [elasticsearch][docs.sinks.elasticsearch], [http][docs.sinks.http], [kafka][docs.sinks.kafka], [new_relic][docs.sinks.new_relic], and [11 more...][docs.sinks]
...
[docs.sinks.new_relic]: https://vector.dev/docs/reference/sinks/new_relic
